...
import { baseHref } from "./config.js";
 ...
 */
export function effectiveBaseHref(req, configuredBasePath) {
...
function cacheControlFor(filePath) {
    ...
    if (relative.endsWith('/index.html') || relative.endsWith('index.html'))
        return NO_CACHE;
 ...
 */
export function mountClient(app, clientDir, basePath) {
